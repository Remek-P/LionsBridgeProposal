...
function Grid() {
  ...
  return (
      <ul className={classes.grid} role="list">
        ...
        <GridItemText count={count} setCount={setCount} id="gridItem5" key={5} textItem="#real estate" alt="#real estate" />
        <GridItemPicture id="gridItem6" key={6} path={`${path}car.jpg`} alt="" />
        <GridItemPicture id="gridItem7" key={7} path={`${path}home_mood.jpg`} alt="" />
        <GridItemText count={count} setCount={setCount} id="gridItem8" key={8} textItem="#people centric" alt="#people centric" />
        <GridItemPicture id="gridItem9" key={9} path={`${path}laptop.jpg`} alt=""/>
        <GridItemText count={count} setCount={setCount} id="gridItem10" key={10} textItem="#invest" alt="#invest" />
        ...
        <GridItemText count={count} setCount={setCount} id="gridItem16" key={16} textItem="#technology" alt="#technology" />
