import classes
  from "@/pages/components/grid/grid-item/grid-item-survey/form/partial2/grid-item-survey-partial2.module.scss";
import Button from "@/pages/components/button/button";

function GridItemSurveyPartial2({ selected }) {

  const svg = <svg viewBox="0 0 47 48" xmlns="http://www.w3.org/2000/svg">
    <rect x="0.5" y="0.5625" />
    <path
      ...
      <>
        ...
        <div className={classes.gridFormPartial2MailContainer}>
          ...
          <div className={classes.gridFormPartial2InputContainer}>
            <input type="email" className={classes.gridFormPartial2Input} id="mail" placeholder="Your email address"/>
            <Button className={classes.gridFormPartial2Button} type="submit" text={svg}/>
          </div>
        </div>
      </>
  );
